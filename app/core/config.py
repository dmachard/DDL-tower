...
class Settings(BaseSettings):
    ...
    TEMPLATE_MATCH_MIN_CONFIDENCE: float = float(_yaml_config.get("template_match_min_confidence", 0.50))
    ...
    GIT_EXPORT_TYPE: str = os.getenv("GIT_EXPORT_TYPE", _yaml_git.get("export_type", "all"))
